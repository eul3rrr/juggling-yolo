        ...
        def do_GET(self):
            try:
                ...
                if parsed.path == '/frame':
                    ...
                    return
                assets = {'/': 'index.html', '/app.js': 'app.js', '/annotation_helpers.js': 'annotation_helpers.js', '/annotation_viewport.js': 'annotation_viewport.js', '/fast_accept.js': 'fast_accept.js', '/styles.css': 'styles.css'}
