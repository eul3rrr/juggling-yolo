...
21. **H7 v2: re-classify YouTube BALLISTIC edges as
    ...
    region.** v8 shows that most YouTube BALLISTIC
    edges are catch+throws in disguise. Adding a
    hand-region check at chain construction time
    could fix the YouTube H10 v5 over-counting at
    its source.
22. **H10 v7: length-dependent weight (w8v8 ∝
    n_tracklet_pts)** — generalize H10 v6b without
    needing video identification. ~20 lines of code.
